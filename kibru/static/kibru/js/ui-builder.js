(function ($) {
    ...
    const $body = $('body');
    const $footer = $('footer');
    const $sidebar_ul = $('aside#kibruy-sidebar nav ul:first-child');
    const $sidebar = $('aside#kibruy-sidebar');
    const $navbar = $('nav#kibruy-navbar');
    const $logo = $('#kibruy-logo');
    const $actions = $('#kibruy-actions');
    const buttons = [
        "primary",
        "secondary",
        "info",
    ...
    function themeSpecificTweaks(theme) {
        if (darkThemes.indexOf(theme) > -1) {
            ...
            $("#kibru-btn-style-primary").val('btn-primary').change();
            $("#kibru-btn-style-secondary").val('btn-secondary').change();
            $body.addClass('dark-mode');
        } else {
            $('#navbar-variants .bg-white').click();
            $("#kibru-btn-style-primary").val('btn-outline-primary').change();
            $("#kibru-btn-style-secondary").val('btn-outline-secondary').change();
    ...
    function themeChooserListeners() {
        ...
        $("#kibru-theme-chooser").on('change', function () {
            let $themeCSS = $('#kibru-theme');
        ...
        $("#kibru-dark-mode-theme-chooser").on('change', function () {
            let $themeCSS = $('#kibru-dark-mode-theme');
            // If we are using the default theme, there will be no theme css, just the bundled one in adminlte
    ...
    function buttonStyleListeners() {
        buttons.forEach(function(btn) {
            $("#kibru-btn-style-" + btn).on('change', function () {
    ...
    function setFromExisting() {
        $('#kibru-theme-chooser').val(window.ui_changes['theme']);
        $('#kibru-dark-mode-theme-chooser').val(window.ui_changes['dark_mode_theme']);
        ...
        // set button styles
        buttons.forEach(function(btn) {
            $("#kibru-btn-style-" + btn).val(window.ui_changes['button_classes'][btn]);
        });
